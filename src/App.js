...
import TratamentoReclamacoes from "./adminPages/denuncias/TratamentoReclamacoes";
...
import NovaDenunciaReclamacao from "./adminPages/reclamacaoUsuarios/NovaDenunciaReclamacao";
  import   PublicContextProvider   from "./adminPages/reclamacaoUsuarios/PublicUserContext";
...
const App = () => {
  ...
  const [sedeParam, setSedeParam] = useState({})
  ...
  return (
    <Router>
      <div>
        ...
        value = {{ userSavedValue, setUserSavedValue}}>
          <Routes>
            <Route
              exact
              path={"/novaDenunciaReclamacao"}
              element={<NovaDenunciaReclamacao />}
            />
          </Routes>
        </PublicUserContext.Provider>
      </div>
            ...
            <div>
              ...
              <div className="container">
                ...
                <Routes>
                  ...
                  <Route
                    path="/listagemDenuncia"
                    element={<ListagemDenuncia />}
                  />
                  <Route
                    path="/tratamentoDenuncia/:id"
                    element={<TratamentoReclamacoes />}
                  />

                  <Route
                    path="/listagemAvaliacoes"
                    element={<ListagemAvaliacoes />}
                  />
                  <Route
                    path="/ListagemSugestoes"
                    element={<ListagemSugestoes />}
                  />

                  <Route
                    path="/listagemTipoDenuncia"
                    element={<ListagemTipoDenuncia />}
                  />
                  ...
                  <Route
                    exact
                    path="/tipoDenuncia"
                    element={<TipoDeDenuncias />}
                  />

                  <Route path="/listaAgencias" element={<ListagemAgencias />} />
                  <Route
                    path="/afetacaoSedeAgencia/:id"
                    element={<AfetacaoSedeAgencia />}
                  />

                  <Route
                    path="/gestaoDenuncias"
                    element={<EstisticaPorSede />}
                  />
                </Routes>
              </div>
            </div>
