...
import PaisServices from "../../services/admin/Pais.service";
...
const PaisSearchTable = forwardRef((props, ref) => { // forwardRef is used to update method from this file from ather files
    ...
    const columns = [
        ...
        {
            field: 'pais', headerName: t('pais'), flex: 3, headerClassName: classes.paper,
            renderCell: (params) => {
                return (
                    <>
                        <span style={{ fontSize: "11px" }}>
...
export default PaisSearchTable;